...
public class GeoStudioProtocol extends BaseProtocol {

    public GeoStudioProtocol() {
        super("geostudio");
    ...
    public void initTrackerServers(List<TrackerServer> serverList) {
        TrackerServer server = new TrackerServer(new ServerBootstrap(), this.getName()) {
            ...
            protected void addSpecificHandlers(ChannelPipeline pipeline) {
                ...
                pipeline.addLast("objectDecoder", new GeoStudioProtocolDecoder(GeoStudioProtocol.this));
            }
        };
