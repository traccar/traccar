...
import org.digitalegiz.broadcast.BroadcastService;
import org.digitalegiz.broadcast.MulticastBroadcastService;
import org.digitalegiz.broadcast.RedisBroadcastService;
import org.digitalegiz.broadcast.NullBroadcastService;
import org.digitalegiz.config.Config;
import org.digitalegiz.config.Keys;
import org.digitalegiz.database.LdapProvider;
import org.digitalegiz.database.OpenIdProvider;
import org.digitalegiz.database.StatisticsManager;
import org.digitalegiz.forward.EventForwarder;
import org.digitalegiz.forward.EventForwarderJson;
import org.digitalegiz.forward.EventForwarderAmqp;
import org.digitalegiz.forward.EventForwarderKafka;
import org.digitalegiz.forward.EventForwarderMqtt;
import org.digitalegiz.forward.PositionForwarder;
import org.digitalegiz.forward.PositionForwarderJson;
import org.digitalegiz.forward.PositionForwarderAmqp;
import org.digitalegiz.forward.PositionForwarderKafka;
import org.digitalegiz.forward.PositionForwarderRedis;
import org.digitalegiz.forward.PositionForwarderUrl;
import org.digitalegiz.forward.PositionForwarderMqtt;
import org.digitalegiz.forward.PositionForwarderWialon;
import org.digitalegiz.geocoder.AddressFormat;
import org.digitalegiz.geocoder.BanGeocoder;
import org.digitalegiz.geocoder.BingMapsGeocoder;
import org.digitalegiz.geocoder.FactualGeocoder;
import org.digitalegiz.geocoder.GeoapifyGeocoder;
import org.digitalegiz.geocoder.GeocodeFarmGeocoder;
import org.digitalegiz.geocoder.GeocodeXyzGeocoder;
import org.digitalegiz.geocoder.Geocoder;
import org.digitalegiz.geocoder.GisgraphyGeocoder;
import org.digitalegiz.geocoder.GoogleGeocoder;
import org.digitalegiz.geocoder.HereGeocoder;
import org.digitalegiz.geocoder.LocationIqGeocoder;
import org.digitalegiz.geocoder.MapQuestGeocoder;
import org.digitalegiz.geocoder.MapTilerGeocoder;
import org.digitalegiz.geocoder.MapboxGeocoder;
import org.digitalegiz.geocoder.MapmyIndiaGeocoder;
import org.digitalegiz.geocoder.NominatimGeocoder;
import org.digitalegiz.geocoder.OpenCageGeocoder;
import org.digitalegiz.geocoder.PositionStackGeocoder;
import org.digitalegiz.geocoder.PlusCodesGeocoder;
import org.digitalegiz.geocoder.TomTomGeocoder;
import org.digitalegiz.geocoder.GeocodeJsonGeocoder;
import org.digitalegiz.geolocation.GeolocationProvider;
import org.digitalegiz.geolocation.GoogleGeolocationProvider;
import org.digitalegiz.geolocation.OpenCellIdGeolocationProvider;
import org.digitalegiz.geolocation.UnwiredGeolocationProvider;
...
import org.digitalegiz.helper.ObjectMapperContextResolver;
import org.digitalegiz.helper.WebHelper;
import org.digitalegiz.mail.LogMailManager;
import org.digitalegiz.mail.MailManager;
import org.digitalegiz.mail.SmtpMailManager;
import org.digitalegiz.session.cache.CacheManager;
import org.digitalegiz.sms.HttpSmsClient;
import org.digitalegiz.sms.SmsManager;
import org.digitalegiz.sms.SnsSmsClient;
import org.digitalegiz.speedlimit.OverpassSpeedLimitProvider;
import org.digitalegiz.speedlimit.SpeedLimitProvider;
import org.digitalegiz.storage.DatabaseStorage;
import org.digitalegiz.storage.MemoryStorage;
import org.digitalegiz.storage.Storage;
import org.digitalegiz.web.WebServer;
