...
import org.digitalegiz.schedule.ScheduleManager;
import org.digitalegiz.storage.DatabaseModule;
import org.digitalegiz.web.WebModule;
...
public final class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length > 0 && args[0].startsWith("--")) {
            WindowsService windowsService = new WindowsService("digitalegiz") {
                @Override
                public void run() {
                    Main.run(configFile);
                }
            ...
            switch (args[0]) {
                case "--install":
                    windowsService.install("digitalegiz", null, null, null, null, configFile);
                    return;
                case "--uninstall":
