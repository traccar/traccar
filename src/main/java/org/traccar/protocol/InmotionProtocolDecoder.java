/*
 * Copyright 2019 Celso Providelo (cprov@gwyddion.com)
 *
...
public class InmotionProtocolDecoder extends BaseProtocolDecoder {

    private final Map<Integer, ByteBuf> photos = new HashMap<>();

    public InmotionProtocolDecoder(Protocol protocol) {
        super(protocol);
    }
    ...
    // public static final int MSG_TRANSITION = 0x98;
