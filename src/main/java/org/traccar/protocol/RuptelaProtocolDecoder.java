...
public class RuptelaProtocolDecoder extends BaseProtocolDecoder {
    ...
    private void decodeDriver(Position position, String part1, String part2) {
        Long driverIdPart1 = (Long) position.removeAttribute(part1);
        Long driverIdPart2 = (Long) position.removeAttribute(part2);
    ...
    protected Object decode(
        ...
        if (type == MSG_RECORDS || type == MSG_EXTENDED_RECORDS) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                Long tagIdPart1 = (Long) position.removeAttribute(Position.PREFIX_IO + 760);
                Long tagIdPart2 = (Long) position.removeAttribute(Position.PREFIX_IO + 761);
