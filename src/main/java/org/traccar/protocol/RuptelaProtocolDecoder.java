...
public class RuptelaProtocolDecoder extends BaseProtocolDecoder {
    ...
    private void decodeParameter(Position position, int id, ByteBuf buf, int length) {
        switch (id) {
            ...
            case 98 -> position.set(Position.KEY_FUEL_LEVEL_PERCENTAGE, readValue(buf, length, false) * 100 / 255.0);
            ...
            case 207 -> position.set(Position.KEY_FUEL_LEVEL_PERCENTAGE, readValue(buf, length, false) * 0.4);
