...
public class OmniProtocol extends BaseProtocol {
    ...
    public OmniProtocol(Config config) {
        setSupportedDataCommands(
                ...
                "headlightOff",
                "taillightFlashingOn",
                "taillightFlashingOff",
                "inchSpeedDisplayOn",
                "inchSpeedDisplayOff",
                "cruiseOn",
                "cruiseOff",
                "blockChangeSpeedModeOn",
                "blockChangeSpeedModeOff",
                "headlightControlOn",
                "headlightControlOff",
                "speedLimitEco",
                "speedLimitNormal",
                ...
                "lookForOn",
                "buzzerControlOn",
                "set30MinGeoIntervalLocked",
                "setGeoIntervalLocked",
                "setGeoInterval5SecUnlocked",
                "setGeoIntervalUnlocked",
                "unlockBatteryLock",
                "lockBatteryLock",
                "unlockWheelLock",
                "lockWheelLock",
                ...
                "updateIotFirmware",
                "updateBms1Firmware",
                "disableUnlockStatusUploadInformation");
