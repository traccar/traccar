...
public class Gt06EvProtocolDecoder extends BaseProtocolDecoder {

    private final Map<Integer, ByteBuf> photos = new HashMap<>();

    public Gt06EvProtocolDecoder(Protocol protocol) {
        super(protocol);
    }
	...
	int bat = buf.readUnsignedByte();
        ...
        //position.set(Position.KEY_BATTERY_LEVEL, bat);
	...
	position.set(Position.KEY_VIN,voltage);
        ...
        //position.set("testH", batv | buf.readUnsignedByte());
	...
	position.set("workingVoltageH",(float)((((bat) & 0x0F) | batv) / 10.0));

	buf.readUnsignedByte();
        //position.set("test", buf.readUnsignedShort());
