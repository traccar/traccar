/*
 * Copyright 2015 - 2018 Celso Providelo (cprov@gwyddion.com)
 *
...
public class InmotionProtocolEncoder extends BaseProtocolEncoder {
    ...
    protected Object encodeCommand(Command command) {
        ...
        switch (command.getType()) {
            case Command.TYPE_ENGINE_STOP:
                return encodeContent(command.getDeviceId(), "UNABLE#");
            case Command.TYPE_ENGINE_RESUME:
                return encodeContent(command.getDeviceId(), "ENABLE#");
