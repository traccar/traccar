...
public class TeltonikaProtocolDecoder extends BaseProtocolDecoder {
    ...
    static {
        ...
        // Sizes verified against the Teltonika wiki and TCT Config Tool. PIDs 205,
        // 449, 641 and 800 differ from the FM family, so they are scoped to FTC.
        register(9, ftc9XX, (p, b) -> p.set(Position.PREFIX_ADC + 1, b.readUnsignedShort() * 0.001));
        register(70, ftc9XX, (p, b) -> p.set(Position.KEY_DEVICE_TEMP, b.readShort() * 0.1));
        ...
        register(800, ftc9XX, (p, b) -> p.set(Position.KEY_POWER, b.readUnsignedInt() * 0.001));

        // FTC305 Dallas temperature sensors
