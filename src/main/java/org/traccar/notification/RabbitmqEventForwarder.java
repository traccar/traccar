...
public abstract class RabbitmqEventForwarder {
    ...
    public final void forwardEvent(Event event, Position position, Set<Long> users, RabbitmqManager rabbitmqManager) {
        forwardToRabbitmq(event, position, users,rabbitmqManager);
    }
    ...
    protected abstract void forwardToRabbitmq(
            Event event, Position position, Set<Long> users, RabbitmqManager rabbitmqManager);
