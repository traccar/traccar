...
public class Tk103ProtocolDecoderTest extends ProtocolTest {
    ...
    public void testDecode() throws Exception {
        ...
        verify(decoder, text(
                ...
                position(Checks.ATTRIBUTES).attribute(Position.KEY_BATTERY_LEVEL, 85));

        verify(decoder, text(
                "(072105039432BP00352672105039432HSOP4B)"),
                position(Checks.ATTRIBUTES).attribute(Position.KEY_BATTERY_LEVEL, 75));
        ...
        verify(decoder, text(
                ...
                position(Checks.ATTRIBUTES).attribute("batteryTemp2", 26));
        ...
        verify(decoder, text(
                ...
                position(Checks.ATTRIBUTES).attribute(Position.KEY_VIN, "5J6RW2H53HL066029"));

        verify(decoder, text(
                "(044027395704BQ81,ALARM,1,164,151101A2238.5237N11349.4571E0.7031241010.0000,00000000)"),
                position().attribute(Position.KEY_ALARM, Position.ALARM_OVERSPEED));
        ...
        verify(decoder, text(
                ...
                position().attribute(Position.KEY_FUEL, 0));
        ...
        verify(decoder, text(
                ...
                position().location("2015-10-24T05:51:48.000Z", true, -25.92255, 28.92222));
        ...
        verify(decoder, text(
                ...
                position().location("2014-04-24T11:28:25.000Z", true, 45.45586, 9.16626));
