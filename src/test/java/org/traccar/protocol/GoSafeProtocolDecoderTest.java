...
public class GoSafeProtocolDecoderTest extends ProtocolTest {
    ...
    public void testDecode() throws Exception {
        ...
        verify(decoder, buffer(
                ...
                position().attribute(Position.PREFIX_TEMP + 3, 24.0));
        ...
        verify(decoder, buffer(
                ...
                position().attribute(Position.PREFIX_TEMP + 0, 22.5));
        ...
        verify(decoder, buffer(
                ...
                position().attribute(Position.KEY_EVENT, 0x1C),
                position());
