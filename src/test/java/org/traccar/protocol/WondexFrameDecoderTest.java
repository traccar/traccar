...
public class WondexFrameDecoderTest extends ProtocolTest {
    ...
    public void testDecode() throws Exception {
        ...
        verify(channel, binary("f0d70b0001ca9a3b"));

        channel = channel(inject(new WondexFrameDecoder()));

        verify(channel, binary("313034343938393630312c32303133303332333039353531352c31332e3537323737362c35322e3430303833382c302c3030302c37322c302c320d0a"),
        ...
        verify(channel, binary("d0d70b0001ca9a3b"),
