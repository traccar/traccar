...
public class Gps103ProtocolDecoderTest extends ProtocolTest {
    ...
    public void testDecode() throws Exception {
        ...
        verify(decoder, text(
                ...
                position(Checks.ATTRIBUTES).attribute(Position.KEY_ALARM, Position.ALARM_VIBRATION));
        ...
        verify(decoder, text(
                ...
                position().attribute(Position.PREFIX_TEMP + 1, 11));
