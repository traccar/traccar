...
public class Xexun2FrameDecoderTest extends ProtocolTest {
    ...
    public void testDecode() throws Exception {
        ...
        verify(channel, binary("faaf0014000286147503139003400032f2b001002f4260b0d6a0008019104a3378323130333135317c323130333132303100704020308715758089502023015648643670faaf"),
        ...
        verify(channel, binary("FAAF123456FBBF01123456FBBF02123456FAAF"),
