...
public class OsmAndProtocolDecoderTest extends ProtocolTest {
    ...
    public void testDecodeJson() throws Exception {
        ...
        Object requestData = request(HttpMethod.POST, "/", new ReadOnlyHttpHeaders(true, "Content-Type", "application/json"), buffer(
        ...
        verifyAttribute(decoder, requestData, "device_string_test", "long_device_id");
        verifyAttribute(decoder, requestData, "device_bool_test", true);
        verifyAttribute(decoder, requestData, "device_bool_false_test", false);
        verifyAttribute(decoder, requestData, "device_integer_test", 1L);
        verifyAttribute(decoder, requestData, "device_integer_twelve_test", 12L);
        verifyAttribute(decoder, requestData, "device_double_test", 1.345);
        verifyAttribute(decoder, requestData, "device_very_long_double_test", 1763636.3442);
