...
public class OsmAndProtocolDecoderTest extends ProtocolTest {
    ...
    public void testDecodeJson() throws Exception {
        ...
        verifyDecode(decoder, request(HttpMethod.POST, "/", new ReadOnlyHttpHeaders(true, "Content-Type", "application/json"), buffer(
        ...
        verifyDecode(decoder, request(HttpMethod.POST, "/", new ReadOnlyHttpHeaders(true, "Content-Type", "application/json"), buffer(
                ...
                position().attribute("device_integer_twelve_test", 12L));
    ...
    public void testDecodeQuery() throws Exception {
        ...
        verifyDecode(decoder, request(
                ...
                position()
                        .network(network()
                                ...
                                .wifi(wifi().mac("00:14:22:01:23:45").signal(-80))
                                .wifi(wifi().mac("00:1C:B3:09:85:15").signal(-70))));
        ...
        verifyDecode(decoder, request(
                ...
                position().location("2016-01-27T18:55:47Z", true, 42.06288, -88.23412));
        ...
        verifyDecode(decoder, request(
                ...
                position().location("2017-09-07T05:56:50Z", true, 40.7232948571, -74.0061408571));
