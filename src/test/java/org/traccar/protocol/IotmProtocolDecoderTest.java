...
public class IotmProtocolDecoderTest extends ProtocolTest {
    ...
    public void testDecode() throws Exception {
        ...
        verifyPositions(decoder, false, MqttMessageBuilders.publish().payload(binary(
                "020208009188752DE7120300030A002000AD59000146543250030A002200AD59643346543250FB"))
                .qos(MqttQoS.EXACTLY_ONCE).messageId(1).build());

        verifyPositions(decoder, false, MqttMessageBuilders.publish().payload(binary(
                "020208004f6af053901403000135007715ec5f0d02b000485cea73083041040b30ee050030ae38040020120e00d0d34bc9412e9c5d4212000806ee00feff011300006d006e"))
                .qos(MqttQoS.EXACTLY_ONCE).messageId(1).build());
        ...
        verifyPositions(decoder, false, MqttMessageBuilders.publish().payload(binary(
                "020208009188752DE71203000109002000AD590500309635F3"))
                .qos(MqttQoS.EXACTLY_ONCE).messageId(1).build());
