...
public class MegastekProtocolDecoderTest extends ProtocolTest {
    ...
    public void testDecode() throws Exception {
        ...
        verifyDecode(decoder, text(
                ...
                position().location("2026-09-16T12:34:56.000Z", false, 55.92593, 0));
        ...
        verifyDecode(decoder, text(
                ...
                position().attribute(Position.KEY_BATTERY_LEVEL, 78));
        ...
        verifyDecode(decoder, text(
                ...
                position().attribute(Position.KEY_ALARM, Position.ALARM_POWER_ON));
        ...
        verifyDecode(decoder, text(
                ...
                position().location("2014-02-24T10:47:42.000Z", true, 22.63675, 114.03299));
        ...
        verifyDecode(decoder, text(
                ...
                position().attribute(Position.KEY_CHARGE, true));
