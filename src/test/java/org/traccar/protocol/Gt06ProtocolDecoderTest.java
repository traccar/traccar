...
public class Gt06ProtocolDecoderTest extends ProtocolTest {
    ...
    public void testDecode() throws Exception {
        ...
        verifyDecode(decoder, binary(
                ...
                position(Checks.ATTRIBUTES).attribute(Position.KEY_POWER, 4.05));

        verifyDecode(decoder, binary(
                "78782da41a0509160203cf05be31f80c306530001c0010012ed000007ef40000000006428b074205041302ff0009389c0d0a"),
                position(Checks.NONE).attribute(Position.KEY_ALARM, Position.ALARM_TAMPERING));

        verifyDecode(decoder, binary(
                "78782e610869412070143950190a1e0d3806c802b0eb0f0561ecdc00d80002d404000004215f0e000001395581000d1ca60d0a"),
                position(Checks.NONE).attribute(Position.KEY_DRIVER_UNIQUE_ID, "20534657"));

        verifyDecode(decoder, binary(
                "7979001f70002c00046919c641007f000ec4a82841074a7fff64012201dc071ea430360d0a"),
                position(Checks.ATTRIBUTES).attribute("tag1Temp", 29.0));

        verifyDecode(decoder, binary(
                "79790008940b02e3048614200d0a"),
                position(Checks.ATTRIBUTES).attribute(Position.KEY_POWER, 7.39));
        ...
        verifyDecode(decoder, binary(
                "787818a300000005321e020000000002584f000100060000008f920d0a"),
                position(Checks.ATTRIBUTES).attribute(Position.KEY_STEPS, 600L));

        verifyDecode(decoder, binary(
                "7979000e941e000000d5000002ee00f59b850d0a"),
                position(Checks.ATTRIBUTES).attribute(Position.KEY_HUMIDITY, 75.0));
        ...
        verifyDecode(decoder, binary(
                ...
                position().attribute("eventFiles", "EVENT_862798052429087_00000000_2024_11_12_22_20_06_I_56.mp4,EVENT_862798052429087_00000000_2024_11_12_22_20_06_F_55.mp4"));
        ...
        verifyDecode(decoder, binary(
                ...
                position(Checks.ATTRIBUTES).attribute(Position.PREFIX_TEMP + 1, 28.4));

        verifyDecode(decoder, binary(
                "787817360005040002003201010018020192006a015f0324aeaf0d0a"),
                position(Checks.ATTRIBUTES).attribute(Position.KEY_BATTERY, 4.02));
        ...
        verifyDecode(decoder, binary(
                ...
                position(Checks.ATTRIBUTES).attribute(Position.KEY_RESULT, "D7520A62"));
        ...
        verifyDecode(decoder, binary(
                ...
                position(Checks.ATTRIBUTES).attribute(Position.KEY_POWER, null));
        ...
        verifyDecode(decoder, binary(
                ...
                position(Checks.NONE).attribute(Position.KEY_DRIVING_TIME, 0));

        verifyDecode(decoder, binary(
                "78781219012ed042cc00954d00040419000056fe290d0a"),
                position(Checks.ATTRIBUTES).attribute(Position.KEY_ALARM, Position.ALARM_LOW_BATTERY));

        verifyDecode(decoder, binary(
                "78782DA4150817073B10CF032EEA9C0B6CE0800015141001CC0100009A00000000000A6F24014605041900FF01908A640D0A"),
                position(Checks.NONE).attribute(Position.KEY_ALARM, Position.ALARM_LOW_BATTERY));
        ...
        verifyDecode(decoder, binary(
                ...
                position(Checks.ATTRIBUTES).attribute(Position.KEY_ALARM, Position.ALARM_TAMPERING));

        verifyDecode(decoder, binary(
                "7878131302801900002e42016f000000003a0177ef180d0a"),
                position(Checks.ATTRIBUTES).attribute(Position.KEY_POWER, 3.67));

        verifyDecode(decoder, binary(
                "78782526160913063918c002780fab0c44750f00040008027f14084c0038420600030c020007398e0d0a"),
                position().attribute(Position.KEY_ALARM, Position.ALARM_TAMPERING));

        verifyDecode(decoder, binary(
                "7979000d940516090908081c030defbd2d0d0a"),
                position(Checks.ATTRIBUTES).attribute(Position.KEY_DOOR, true));
        ...
        verifyDecode(decoder, binary(
                ...
                position(Checks.ATTRIBUTES).attribute("serial", "RFID:008FB2BEBA39"));
        ...
        verifyDecode(decoder, binary(
                ...
                position().attribute(Position.PREFIX_TEMP + 1, 0x1c));

        verifyDecode(decoder, binary(
                "7878151330802b00000642014f0008720000802b5ee4d4c90d0a"),
                position(Checks.ATTRIBUTES).attribute(Position.KEY_BATTERY_LEVEL, 6));

        verifyDecode(decoder, binary(
                "7878281520000000003c49434349443a38393838323339303030303039373330323635303e00020d446f260d0a"),
                position(Checks.ATTRIBUTES).attribute(Position.KEY_ICCID, "89882390000097302650"));

        verifyDecode(decoder, binary(
                "797900099b0380d600046f91e90d0a"),
                position(Checks.ATTRIBUTES).attribute(Position.KEY_RESULT, "80d600"));
        ...
        verifyDecode(decoder, binary(
                ...
                position(Checks.ATTRIBUTES).attribute(Position.KEY_RESULT, "32382e33a1e60d0a"));
        ...
        verifyDecode(decoder, binary(
                ...
                position(Checks.ATTRIBUTES).attribute(Position.KEY_ICCID, "8966051912408052452"));
        ...
        verifyDecode(decoder, binary(
                ...
                position(Checks.ATTRIBUTES).attribute(Position.KEY_DRIVER_UNIQUE_ID, "4277efef"));
        ...
        verifyDecode(decoder, binary(
                ...
                position(Checks.ATTRIBUTES).attribute(Position.KEY_ALARM, Position.ALARM_GENERAL));
        ...
        verifyDecode(decoder, binary(
                ...
                position().attribute(Position.PREFIX_ADC + 1, 4.48));
        ...
        verifyDecode(decoder, binary(
                ...
                position().attribute(Position.KEY_ALARM, Position.ALARM_REMOVING));
        ...
        verifyDecode(decoder, binary(
                ...
                position(Checks.ATTRIBUTES).attribute(Position.KEY_RESULT, "0235393030423438434542384103"));
        ...
        verifyDecode(decoder, binary(
                ...
                position(Checks.NONE).attribute(Position.KEY_ALARM, Position.ALARM_REMOVING));
        ...
        verifyDecode(decoder, binary(
                ...
                position().location("2015-10-20T14:21:11.000Z", true, 54.94535, 24.01762));
        ...
        verifyDecode(decoder, binary(
                ...
                position(Checks.ATTRIBUTES).attribute(Position.KEY_ALARM, Position.ALARM_ACCELERATION));

        verifyDecode(decoder, binary(
                "78780c95130a0209321c91000112800d0a"),
                position(Checks.ATTRIBUTES).attribute(Position.KEY_ALARM, Position.ALARM_BRAKING));
        ...
        verifyDecode(decoder, binary(
                ...
                position().attribute(Position.KEY_ALARM, Position.ALARM_BRAKING));
        ...
        verifyDecode(decoder, binary(
                ...
                position().attribute(Position.KEY_ALARM, Position.ALARM_ACCIDENT));

        decoder.setModelOverride("LW4G-4B");

        verifyDecode(decoder, binary(
                "78780a13560604f0830ccf986f0d0a"),
                position(Checks.ATTRIBUTES).attribute(Position.KEY_POWER, 13.1));

        verifyDecode(decoder, binary(
                "78782516180516150812c804b50ee80880e40805dcf909012e000000986633460604190106c393490d0a"),
                position(Checks.NONE).attribute(Position.KEY_ALARM, Position.ALARM_ACCELERATION));

        decoder.setModelOverride("SEEWORLD");

        verifyDecode(decoder, binary(
                "78780a134506560b0102242b850d0a"),
                position(Checks.ATTRIBUTES).attribute(Position.KEY_POWER, 11.0));

        decoder.setModelOverride("R11");

        verifyDecode(decoder, binary(
                "78780a13460b120400160642c20d0a"),
                position(Checks.ATTRIBUTES).attribute(Position.KEY_POWER, 28.34));
        ...
        verifyDecode(decoder, binary(
                ...
                position(Checks.NONE).attribute(Position.KEY_HOURS, 22140000L));
        ...
        verifyDecode(decoder, binary(
                ...
                position(Checks.NONE).attribute(Position.KEY_POWER, 12.51));

        verifyDecode(decoder, binary(
                "78783c22010357789648774484180c06142038180c06142038cb03313ee4061fe98300185e090000000000000000460984284c000200000000017101d6f35d0d0a"),
                position(Checks.NONE).attribute(Position.KEY_BATTERY, 4.0));
        ...
        verifyDecode(decoder, binary(
                ...
                position().attribute(Position.KEY_DRIVER_UNIQUE_ID, "0235313030363538303642444603"));
        ...
        verifyDecode(decoder, binary(
                "78783536190c1d0f1724cf026cc9140c367d4000940001cc0025ef0540e88c01000000000064051428000006c3000001453f9201003477560d0a"),
                position());

        verifyDecode(decoder, binary(
                "78783536190c1d0f1724cf026cc9140c367d4000940001cc0025ef0540e88c01000000000064051428000006c3000001453f9201003477560d0a"),
                position().attribute(Position.KEY_DRIVER_UNIQUE_ID, "c3000001453f9201"));

        verifyDecode(decoder, binary(
                "78783536190c1d0f2806cf026cc9140c367d4000540001cc0025ef0540e88c00000000000064051e2800001600000000000000006e5bc2660d0a"),
                position().attribute(Position.KEY_BATTERY, 4.0));

        verifyDecode(decoder, binary(
                "78782d16190c1d0e3b03cf026cc8d40c367d800014000801cc0025ef40e88c450604e801c3000001453f920100271e590d0a"),
                position().attribute(Position.KEY_DRIVER_UNIQUE_ID, "c3000001453f9201"));

        verifyDecode(decoder, binary(
                "78782d16190c1d0f0b07cf026cc89c0c367cf00014000801cc0025ef40e88c460604ea01c3000001453f9201000c103a0d0a"),
                position().attribute(Position.KEY_EVENT, 0xEA));
