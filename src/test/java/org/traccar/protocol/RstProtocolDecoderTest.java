...
public class RstProtocolDecoderTest extends ProtocolTest {
    ...
    public void testDecode() throws Exception {
        ...
        verifyDecode(decoder, text(
                ...
                position(Checks.ATTRIBUTES).attribute(Position.KEY_RESULT, "134"));
        ...
        verifyDecode(decoder, text(
                ...
                position().attribute(Position.KEY_DRIVER_UNIQUE_ID, "001606017031"));
        ...
        verifyDecode(decoder, text(
                ...
                position().attribute(Position.KEY_BATTERY, 3.40));
