...
public class MiniFinderProtocolDecoderTest extends ProtocolTest {
    ...
    public void testDecode() throws Exception {
        ...
        verifyDecode(decoder, text(
                ...
                position(Checks.ATTRIBUTES).attribute("phone1", "040123"));

        verifyDecode(decoder, text(
                "!5,17,V,50"),
                position(Checks.ATTRIBUTES).attribute(Position.KEY_BATTERY_LEVEL, 50));
        ...
        verifyDecode(decoder, text(
                ...
                position().location("2014-02-22T13:40:58.000Z", true, 56.89960, 14.81154));
