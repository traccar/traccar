...
public class ItsProtocolDecoderTest extends ProtocolTest {
        ...
        public void testDecode() throws Exception {
                ...
                verifyPosition(decoder, text(
                                "$Header,iTriangle,BHARAT101C_0267,BR,6,L,861693034634154,KA01I2000,1,09112017,160702,12.976593,N,77.549782,E,25.1,344,15,911.0,1.04,0.68,Airtel,1,1,11.8,3.8,1,C,24,404,45,61b4,9ad9,31,9adb,61b4,35,ffff,0000,33,ffff,0000,31,ffff,0000,0001,00,000014,0.0,0.1,4,()*1E"));
                ...
                verifyPosition(decoder, text(
                                "$Header,iTriangle,BHARAT101C_0267,NR,1,L,864495034490141,KA01I2000,1,19042018,102926,22.846401,N,75.948952,E,0.0,311,5,578.0,3.80,3.67,AirTel,0,1,12.5,4.3,1,C,14,404,93,0456,16db,29,ebd8,0458,28,3843,18ab,25,072e,18ab,22,35da,0458,0000,00,031181,0.0,0.0,0,()*34"));
                ...
                verifyPosition(decoder, text(
                                "$Header,iTriangle,BHARAT101C_0267,NR,1,L,864495034490141,KA01I2000,1,31032018,122247,22.845999,N,75.949005,E,0.0,44,16,545.0,1.19,0.65,AirTel,1,1,12.0,4.3,0,C,13,404,93,0456,16db,27,16dd,0456,22,3843,18ab,19,ebd8,0458,14,072c,18ab,0101,00,003735,0.0,0.0,0,()*48"));

                verifyPosition(decoder, text(
                                "$Header,iTriangle,BHARAT101C_0267,NR,1,L,358250330004309,KA1234,1,05022021,182028,12.982697,N,77.548622,E,0.0,181.0,7,879.0,2.90,2.09,BSNL,0,1,23.0,3.9,1,C,14,404,71,ccc7,2ee0,37,2ee0,ccc6,33,3a98,f24f,32,3a98,f26d,30,3a98,f2a9,0000,01,000677,0.018,0.043,0.000000,()*04"));
