...
messages = {
    ...
    'raveon' : '$PRAVE,1234,0001,3308.9051,-11713.1164,195348,1,10,168,31,13.3,3,-83,0,0,,1003.4*66\r\n',
    ...
    'opengts' : 'GET /gprmc/Data?id=123456789012345&dev=dev_name&acct=account&batt=0&code=0xF020&alt=160.5&gprmc=$GPRMC,191555,A,5025.46624,N,3030.39937,E,0.000000,0.000000,200218,,*2F ',
}
